...
# ╔═╡ 7f4f6a82-f3ca-11ed-3a3a-d39933f11994
begin
	using Molly,Enzyme,Format
end

# ╔═╡ 233363ae-51ba-4f4e-b3b3-0cb41cacfaf8
md"
[kitchin](https://kitchingroup.cheme.cmu.edu/blog/2017/11/14/Forces-by-automatic-differentiation-in-molecular-simulation/)
[Molly](https://juliamolsim.github.io/Molly.jl/stable/differentiable/)
Explain what autodiff is, compare with finite difference like in lecture
Make two versions, compare with finite difference method.
"
...
julia_version = "1.9.0"
manifest_format = "2.0"
project_hash = "2d5831c94c0abaa6cd3c9f4d85b23f6daf905fe7"
...
git-tree-sha1 = "83dcdecdf02067ef75deba50c168e9657bb73392"
uuid = "7e6ae17a-c86d-528c-b3b9-7f778a29fe59"
version = "3.1.4"

[[deps.BioStructures]]
deps = ["BioAlignments", "BioCore", "BioGenerics", "BioSequences", "BioSymbols", "CodecZlib", "DataFrames", "Downloads", "Format", "Graphs", "LinearAlgebra", "MMTF", "MetaGraphs", "RecipesBase", "Statistics"]
git-tree-sha1 = "1389fcdf568de584aa1c5f4a019bc582b7d8a842"
...
[[deps.CellListMap]]
deps = ["DocStringExtensions", "LinearAlgebra", "Parameters", "ProgressMeter", "Random", "Setfield", "StaticArrays", "TestItems"]
git-tree-sha1 = "b30acbed7ef1093187bbad38c48c756b8155664d"
...
[[deps.MMTF]]
deps = ["CodecZlib", "Downloads", "MsgPack"]
git-tree-sha1 = "2af5e4051f50bd99755b84d8bf3547db073992f3"
...
[[deps.Molly]]
deps = ["Atomix", "AtomsBase", "BioStructures", "CUDA", "CellListMap", "ChainRulesCore", "Chemfiles", "Colors", "Combinatorics", "DataStructures", "Distances", "Distributions", "Enzyme", "EzXML", "FLoops", "ForwardDiff", "Graphs", "KernelDensity", "LinearAlgebra", "NearestNeighbors", "Random", "Reexport", "Requires", "SparseArrays", "StaticArrays", "Statistics", "Unitful", "UnitfulChainRules", "UnsafeAtomicsLLVM", "Zygote"]
git-tree-sha1 = "47118c78dc7948d9819341609ac356ec4995485c"
